    ...
    public void render(GuiGraphicsExtractor graphics, int x, int y, int width, int height,
        ...
        for (int i = 0; i < rows.size(); i++) {
            ...
            if (rowBottom > listY && rowTop < listY + dim.h) {
                ...
                graphics.text(mc.font, Component.literal(String.valueOf(data.getName())), 
                ...
                if (data.getDescription() != null) {
                    ...
                    graphics.text(mc.font, Component.literal(String.valueOf(data.getDescription())), 
    ...
    private Identifier getIconTexture(String iconPath) {
        ...
        return iconCache.computeIfAbsent(iconPath, path -> {
            try {
                ...
                textureManager.register(loc, new DynamicTexture(() -> "dynamic_icon", iconImage));
                return loc;
            } catch (Exception e) {
                return null;
            }
