    ...
    public void render(GuiGraphicsExtractor graphics, int x, int y, int width, int height,
        ...
        if (steps != null && !steps.isEmpty()) {
            ...
            if (currentStep != null) {
                ...
                graphics.text(minecraft.font, renderText, 0, 0, renderColor, textProps.shadow());
                if (showCursor) {
                    int cursorX = minecraft.font.width(renderText);
                    graphics.text(minecraft.font, "_", cursorX, 0, renderColor, textProps.shadow());
                }
            ...
            if (fullStr != null) {
                ...
                if ("typewriter".equals(textProps.textAnimation())) {
                    ...
                    if (visibleChars < fullStr.length()) {
                        ...
                        graphics.text(minecraft.font, visibleText, 0, 0, color, textProps.shadow());
                        if ((elapsed / 500) % 2 == 0) {
                            graphics.text(minecraft.font, "_", minecraft.font.width(visibleText), 0, color, textProps.shadow());
                        }
                        graphics.pose().popMatrix();
                        return;
                    }
        ...
        if (finalComponent != null) {
            graphics.text(minecraft.font, finalComponent, 0, 0, color, textProps.shadow());
        } else {
            graphics.text(minecraft.font, finalText, 0, 0, color, textProps.shadow());
        }
        graphics.pose().popMatrix();
    }
