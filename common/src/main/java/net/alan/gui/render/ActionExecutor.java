...
public class ActionExecutor {
    ...
    private void disconnectAndGoToTitle() {
        if (minecraft.level != null) {
            minecraft.level.disconnect(net.minecraft.network.chat.Component.empty());
        }
        minecraft.disconnect(new GenericMessageScreen(net.minecraft.network.chat.Component.translatable("menu.savingLevel")), false);
        minecraft.setScreen(new TitleScreen());
